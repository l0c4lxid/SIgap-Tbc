            ...
            <div class="w-full max-w-2xl">
                ...
                <div class="mt-6 rounded-3xl border border-white/70 bg-white/80 p-8 shadow-xl shadow-emerald-100 backdrop-blur">
                    <div class="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
                        <div>
                            <p class="text-sm font-semibold text-emerald-600">Kode 403</p>
                            <h1 class="mt-2 text-3xl font-bold text-slate-900">Akses ditolak</h1>
                            <p class="mt-3 text-base leading-relaxed text-slate-600">Kamu tidak memiliki izin untuk mengakses halaman ini.</p>
                        </div>
                        <div class="flex items-center justify-start md:justify-end">
                            <div class="h-24 w-24 rounded-full bg-emerald-100/80 text-emerald-600 flex items-center justify-center text-3xl font-bold">403</div>
                        </div>
                    </div>
