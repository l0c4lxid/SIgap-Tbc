                ...
                <div style="background: #ffffff; border-radius: 20px;box-shadow: 0 20px 50px rgba(15, 23, 42, 0.12);padding: 32px; border: 1px solid rgba(148, 163, 184, 0.25);">
                    <div style="display: flex; flex-wrap: wrap; gap: 24px; align-items: center; justify-content: space-between;">
                        <div style="min-width: 220px; flex: 1;">
                            <div style="display: inline-flex; align-items: center; gap: 8px;padding: 6px 14px; border-radius: 999px;background: rgba(16, 185, 129, 0.12); color: #047857;font-size: 12px; font-weight: 600; letter-spacing: 0.12em;text-transform: uppercase;">Kode 500</div>
                            <h1 style="margin: 16px 0 8px; font-size: 32px; font-weight: 700;">Terjadi kesalahan di server</h1>
                            <p style="margin: 0; font-size: 16px; line-height: 1.6; color: #475569;">Ada masalah tak terduga di server. Silakan coba lagi beberapa saat.</p>
                        ...
                        <div style="height: 110px; width: 110px; border-radius: 50%;background: linear-gradient(135deg, #ecfdf5 0%, #d1fae5 100%);display: flex; align-items: center; justify-content: center;color: #047857; font-size: 32px; font-weight: 700;box-shadow: inset 0 0 0 1px rgba(16, 185, 129, 0.2);">500</div>
                    </div>
                </div>
